  ...
  return (
    <section className="relative h-[100dvh] min-h-[600px] flex items-center justify-center pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        <p className="text-accent font-medium tracking-[0.3em] uppercase text-sm mb-6">Estepona · Desde 2014</p>
        ...
        <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto mb-10 leading-relaxed">
          Donde la artesanía tradicional se encuentra con el cuidado personal contemporáneo. Experimenta el arte del
