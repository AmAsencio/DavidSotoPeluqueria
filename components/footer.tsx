    ...
    <footer id="contacto" className="bg-primary text-primary-foreground">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <h4 className="font-semibold text-lg mb-4 text-accent">{t.footer.location}</h4>
          ...
          <div>
            ...
            <div className="flex items-start gap-3 text-primary-foreground/70">
              ...
              <div>
                <p className="mb-2">
                  <span className="font-medium text-primary-foreground">{t.footer.monFri}</span>
                  <br />
                  10:00 - 14:00
                  <br />
                  17:00 - 20:30
                ...
                <p>
                  <span className="font-medium text-primary-foreground">{t.footer.satSun}</span>
                  <br />
                  {t.footer.closed}
                </p>
              </div>
          ...
          <div>
            ...
            <a href="#reservas">
              <Button className="bg-accent text-accent-foreground hover:bg-accent/90 w-full">{t.footer.bookNow}</Button>
            </a>
          </div>
        </div>
